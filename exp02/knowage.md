...
分析上圖，以由切開線往左看之西分寧等效電路，其西分寧等效電壓源電壓為 $$D_0$$ 點 $$D_0V_{ref}$$ 電壓與接地電壓0中心電壓即， $$ \frac {1} {2} D_0 V_{ref} $$ 電阻為兩 $2k\Omega$ 並聯電阻即$$1kΩ$$ 其簡化後電路如圖4 第一次西分寧簡化後電路

![圖4 第一次西分寧簡化後電路： $$V_{ref} \frac {1} {2} D_0$$ 串 $$1KΩ$$ 西分寧](./img/4.png)

圖4的切割線左邊電路，輸出輸出開迴路電壓為 $$V_{ref} \frac {1} {2} (D_1 + \frac {1} {2} D_0)$$ ，電阻為兩個 $$1kΩ$$ 電阻串聯後與$$ 2kΩ $$ 並聯，等效為$$1kΩ$$ 。再西分寧簡化為圖5。
