...
![若取樣於不同弦波的交义點時，無法分辨原訊號為那個弦波](./img/know1_img1.png)
...
![訊號取樣，頻域上有如將原訊號捲起壓扁，並把重疊部分加起來](./img/know1_img2.png)
...
![取樣頻率不為正弦波頻的倍數時取樣不再是正弦波](./img/know1_img3.png)
...
假設原訊號在頻域上$$( - \Omega_0 , \Omega_0)$$之外的區域均為零且取樣頻率$$\Omega_s = \frac{1}{T_s}$$ 大於$$2 \Omega_0$$則原訊號在任何時間的訊號大小可以由取樣所得的訊號之線性組合來重建。
...
![單極性ADC及DAC曲線](./img/know1_img6.png)
\(圖3-6單極性ADC及DAC曲線\)
...
![雙極性ADC及DAC曲線](./img/know1_img7.png)
\(圖3-7雙極性ADC及DAC曲線\)
